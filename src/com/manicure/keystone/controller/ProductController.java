...
public class ProductController extends BaseController {
	...
	@RequestMapping(value = "/product/list/{status}/{groupId}")
	@ResponseBody
	public String getProductList(HttpServletRequest request, HttpServletResponse response, @PathVariable int status, @PathVariable String groupId) {
